...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetail, saveOrUpdateReview, getAllProductReviews, deleteReview, getAdminProducts } = require('../controllers/productController');
const { verifyToken, authorizeRoles } = require('../middleware/auth');
const router = express.Router();

router.route('/products').get(getAllProducts);
router.route('/admin/products').get(verifyToken, authorizeRoles("admin"), getAdminProducts);
